...
const lobbyAreas: LobbyAreaConfig[] = [
  ...
  },
  {
    ...
    selectedImage: assetUrl("/assets/lobby/pulsanti/porta1_selected.png"),
    layout: {
      x: 0,
      y: 0,
      width: LOBBY_IMAGE_WIDTH,
  ...
  },
  {
    ...
    selectedImage: assetUrl("/assets/lobby/pulsanti/porta2_selected.png"),
    layout: {
      x: 0,
      y: 0,
      width: LOBBY_IMAGE_WIDTH,
  ...
  },
  {
    ...
    selectedImage: assetUrl("/assets/lobby/pulsanti/porta3_selected.png"),
    layout: {
      x: 0,
      y: 0,
      width: LOBBY_IMAGE_WIDTH,
...
const getDoorTexturePath = (type: DoorType) => {
  ...
  return assetUrl(`/assets/porte/${colorFolder}/porta_${colorFolder}_base.png`);
};
